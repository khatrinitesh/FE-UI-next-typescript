...
const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles =
    "cursor-pointer z-[9] btnPrimary relative text-[1rem] px-[1rem] border-0  lg:px-[1.5vw] whitespace-nowrap fontpoppinsl transition-colors duration-300 border h-[6vh] 2xl:h-[5vh]";
